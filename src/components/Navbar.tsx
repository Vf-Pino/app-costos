...
import { BarChart3, PlusCircle, History, LogOut, User, Users, ClipboardList } from 'lucide-react';
...
interface NavbarProps {
  activeTab: 'dashboard' | 'registro' | 'auditoria' | 'historial' | 'nomina';
...
export default function Navbar({ activeTab, setActiveTab, userEmail, userRole }: NavbarProps) {
  ...
  const navItems = [
    ...
    { id: 'auditoria' as const, label: 'Auditoría Completa', icon: ClipboardList, roles: ['admin'] },
